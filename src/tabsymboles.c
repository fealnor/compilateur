...
/**
  * Ajoute un nouvel identificateur �  la table des symboles courante.
  ...
  * @param adresse Nombre d'octets de décalage par rapport �  la base de la zone
...
/**
  ...
  * l'UTILISATION d'un identificateur, soit dans un appel �  fonction, une
  ...
  * un local), la fonction renvoie le plus proche, c-� -d le local.
